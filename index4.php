...
<body>
    ...
    <a href="tambah_data3.php">Tambah Data Mahasiswa</a>
    <br><br>
    ...
    <table border="1" cellpadding="10" cellspacing="0">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="hapus3.php?id=<?php echo $row["id"];?>"onclick="return confirm('Apa kamu yakin ingin menghapus data ini?')">Hapus</a>
            </td>
        </tr>
        <?php $i++ ?>
        <?php endforeach; ?>
